...
<div>
    <br>
    <br>
        <a href="${pageContext.request.contextPath}/products" class="btn btn-outline-secondary" role="button">Продукция</a>
        <a href="${pageContext.request.contextPath}/product-filter" class="btn btn-outline-secondary" role="button">Фильтр продукции</a>
    </p>
    <br>
</div>