package com.sportoras.database.configuration;
...
@EnableJpaRepositories(basePackages = "com.sportoras.database.repository")
@ComponentScan("com.sportoras.database")
...
public class DatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
        ...
        factory.setPackagesToScan("com.sportoras.database.entity");
